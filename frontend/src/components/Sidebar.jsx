...
export default function Sidebar({ user }) {
  const navItems = [
    ...
    { name: 'Memberships', path: '/creator/memberships', icon: MembershipsIcon },
    { name: 'Site design', path: '/creator/site-design', icon: SiteDesignIcon },
    { name: 'Analytics', path: '/creator/analytics', icon: AnalyticsIcon },
    { name: 'Apps', path: '/creator/apps', icon: AppsIcon },
    { name: 'Settings', path: '/creator/settings', icon: SettingsIcon },
  ];
...
function MembershipsIcon({ className }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function SiteDesignIcon({ className }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
